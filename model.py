...
class Lstm(torch.nn.Module):
    def __init__(self, args, num_entities, num_relations):
        ...
        self.rnn = torch.nn.LSTM(input_size=int(self.embedding_dim/self.timesteps * args.num_layers * 2), hidden_size=args.hidden_size, num_layers=args.num_layers, batch_first=True, bidirectional=True)
        self.fc = torch.nn.Linear(args.hidden_size,args.embedding_dim)
        self.register_parameter('b', Parameter(torch.zeros(num_entities)))
